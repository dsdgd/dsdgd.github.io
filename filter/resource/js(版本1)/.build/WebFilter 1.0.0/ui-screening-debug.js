//筛选数据UI
define("WebFilter/ui-screening-debug", [ "./ui-slider-debug", "./data-getKeyWord-debug", "./data-ajax-debug", "./ui-hoverBgColor-debug", "./ui-fixHead-debug", "./ui-checkbox-debug", "./ui-moreKey-debug" ], function(require, exports, module) {
    function ui(Json, url) {
        ...
        for (var i in JsonData) {
            ...
            $("#ZlgScreenMain").append(sHtml1);
        }
        for (var i = 0; i < aId1.length; i++) {
            //添加滑动条ui事件
            require("./ui-slider-debug").ui("#" + aId1[i], "#" + aId2[i], aJsonNum[i], Json, url);
        }
        for (var i = 0; i < aId1.length; i++) {
            //添加筛选按钮ui事件
            require("./ui-checkbox-debug").ui("#" + aId01[i], "#" + aId02[i], "#" + aId03[i], "#" + aId04[i], Json, url);
        }
        //展现部分下拉框的关键词
        require("./ui-moreKey-debug").ui(Json, url);
    }
    exports.ui = ui;
});