//初始化
define("js/WebFilter/jQuery.webFilter-debug", [ "./data-processing-debug", "./ui-screening-debug", "./ui-slider-debug", "./data-getKeyWord-debug", "./data-ajax-debug", "./ui-hoverBgColor-debug", "./ui-fixHead-debug", "./ui-checkbox-debug", "./ui-moreKey-debug", "./ui-toggle-debug", "./ui-reset-debug" ], function(require, exports, module) {
        ...
        jQuery(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(Json) {
                    ...
                    //解析筛选数据
                    var oJson = require("./data-processing-debug").init(Json, true, config);
                    //生成筛选数据UI
                    require("./ui-screening-debug").ui(oJson, config);
                    ...
                    //重置UI
                    require("./ui-reset-debug").init("#ZlgReset", config, oJson, sUrl);
                    require("./ui-reset-debug").init(".zlg-reset-one", config, oJson);
                }
            });
        });
    }
