//筛选数据UI
define("js/WebFilter/ui-screening-debug", [ "./ui-slider-debug", "./data-getKeyWord-debug", "./data-ajax-debug", "./data-processing-debug", "./ui-hoverBgColor-debug", "./ui-fixHead-debug", "./ui-checkbox-debug", "./ui-moreKey-debug" ], function(require, exports, module) {
    function ui(Json, config) {
        ...
        for (var i = 0; i < aId01.length; i++) {
            //添加筛选按钮ui事件
            require("./ui-checkbox-debug").ui("#" + aId01[i], "#" + aId02[i], Json, config);
        }
        //展现部分下拉框的关键词
