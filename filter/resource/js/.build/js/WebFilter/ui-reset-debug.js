//重置所有参数
define("js/WebFilter/ui-reset-debug", [ "./data-ajax-debug", "./data-processing-debug", "./ui-hoverBgColor-debug", "./ui-fixHead-debug", "./data-getKeyWord-debug" ], function(require, exports, moudle) {
    function init(obj, config, Json, url) {
        if (url) {
            ...
            $(obj).click(function() {
                ...
                require("./data-ajax-debug").init(url, config);
            });
        } else {
            //单个重置
            $(obj).click(function() {
                ...
                url = require("./data-getKeyWord-debug").init(Json, config);
                require("./data-ajax-debug").init(url, config);
            });
        }
    }
